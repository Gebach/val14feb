...
export default class Store {
  ...
  loadingWords = [
    'Загружается любовь..',
    'Вычисляется степень любви..',
    'Ищятся любимые глазки среди толпы..',
    'Сближение чувств..',
  ]
  ...
  lovesongs = [
    {
      title: 'KSB muzic - Ослепительна',
      cover: KSB_cover,
      path: KSB_oslepitelna,
    },
    {
      title: "Joji - Past Won' Leave My Bed",
      cover: Joji_cover,
      path: Joji_Past_Wont_Leave_My_Bed,
    },
    {
      title: 'Валентин Стрыкало - Бесполезно',
      cover: chtofkalo_1_2_cover,
      path: chtofkalo_1,
    },
    {
      title: 'Валентин Стрыкало - 92',
      cover: chtofkalo_1_2_cover,
      path: chtofkalo_2,
    },
    {
      title: 'Валентин Стрыкало - Ты не такая',
      cover: chtofkalo_3_cover,
      path: chtofkalo_3,
    },
    {
      title: 'Garcon Maigre - Free Candies',
      cover: garcon_maigre_cover,
      path: garcon_maigre,
    },
    {
      title: '125 Rue Montmartre - Hit #2',
      cover: rue_cover,
      path: rue,
    },
    {
    ...
    {
      title: 'ssshhhiiittt! - Любовь',
      cover: shit_1_cover,
      path: shit_1,
    },
    {
      title: 'ssshhhiiittt! - но ты',
      cover: shit_2_cover,
      path: shit_2,
    },
    {
      title: 'Lil Peep - right here',
      cover: peep_1_cover,
      path: peep_1,
    },
    {
      title: 'Lil Peep - we think too much',
      cover: peep_2_cover,
      path: peep_2,
    },
  ]
